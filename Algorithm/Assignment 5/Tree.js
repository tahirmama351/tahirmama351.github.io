...
//     return findMaximumHelper(T, T.root())
// }
// function findMaximumHelper(T, p){
//     if(T.isExternal(p)){
//         return -Infinity;
//     }else{
//         let leftMax = findMaximumHelper(T, T.leftChild(p))
//         let rightMax = findMaximumHelper(T, T.rightChild(p))
//         return Math.max(leftMax, rightMax, p.element())
//     }
// }
// console.log(findMaximum(t0))
